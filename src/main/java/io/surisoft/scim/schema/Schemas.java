...
import io.surisoft.scim.annotation.ScimExtensionType;
import io.surisoft.scim.annotation.ScimResourceType;
import io.surisoft.scim.exception.ScimResourceInvalidException;
import io.surisoft.scim.resources.BaseResource;
import io.surisoft.scim.resources.ScimExtension;
import io.surisoft.scim.resources.ScimResource;
...
public final class Schemas {
  ...
  private static Set<Schema.Attribute> createAttributes(String urn, Optional<String> path, List<Field> fieldList, Set<String> invalidAttributes, String nameBase) throws ScimResourceInvalidException {
    Set<Schema.Attribute> attributes = new TreeSet<>(Comparator.comparing(o -> o.getName()));
