...
import io.surisoft.scim.validator.Urn;
...
public class Schema implements AttributeContainer {
  ...
  public static class Attribute implements AttributeContainer {
    ...
    private Map<String, Attribute> subAttributeNamesMap = new HashMap<>();
    ...
    private transient AttributeAccessor accessor;
    ...
    public Map<String, Attribute> getSubAttributeNamesMap() {
      return subAttributeNamesMap;
    }

    public void setSubAttributeNamesMap(Map<String, Attribute> subAttributeNamesMap) {
  ...
  public void setAttributeNamesMap(Map<String, Attribute> attributeNamesMap) {
